    ...
    public UpdateExample() {
        ApexCharts chart = ApexChartsBuilder.get().withChart(ChartBuilder.get()
                ...
                .withDataLabels(DataLabelsBuilder.get()
                        .withEnabled(false)
                        .build())
                .withSeries(400.0, 430.0, 448.0, 470.0, 540.0, 580.0, 690.0, 1100.0, 1200.0, 1380.0)
        ...
        Button update = new Button("Update", buttonClickEvent -> {
            chart.updateSeries(400.0, 430.0, 448.0, 470.0, 540.0, 580.0, 690.0, 1100.0, 1200.0, 500.0);
